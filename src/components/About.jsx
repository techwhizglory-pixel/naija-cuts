  ...
  return (
    <section id="about" className="relative w-full overflow-hidden">
      ...
      <motion.div
        ...
        style={{
          background:
            'radial-gradient(circle, rgba(200,155,60,0.18), transparent)',
          top: '-10%',
          left: '-5%',
        }}
      ...
      <motion.div
        ...
        style={{
          background:
            'radial-gradient(circle, rgba(176,122,42,0.15), transparent)',
          bottom: '0%',
          right: '5%',
        }}
      ...
      <div ref={ref} className="relative z-10 max-w-6xl mx-auto py-24 px-8">
        ...
        <div className="grid grid-cols-2 gap-16 items-center mb-20">
          ...
          >
            ...
            >
              <p className="font-playfair text-3xl font-black text-white">
                8+
              </p>
          ...
          >
            ...
            <h2 className="font-playfair text-5xl font-black text-white mb-6 leading-tight">
              Our Commitment <br />
            ...
            <p className="text-white/65 text-base leading-relaxed mb-6">
              At Naija Cuts, we believe grooming is more than just a haircut —
              it’s an experience. Founded in Lagos with a passion for precision
              and style, we have been serving the Nigerian gentleman for over
              8 years across Lagos and Abuja.
            </p>

            <p className="text-white/65 text-base leading-relaxed mb-8">
              Every barber on our team is trained to the highest standard.
              We combine traditional techniques with modern styles to give
              you a look that commands respect wherever you go.
            </p>

            <motion.button
              className="px-8 py-4 text-sm font-medium tracking-widest uppercase text-white rounded-xl"
              style={{
                background:
                  'linear-gradient(135deg, #C89B3C, #8A6420)',
              }}
              whileHover={{
                scale: 1.05,
                boxShadow: '0 10px 30px rgba(200,155,60,0.25)',
              }}
              whileTap={{ scale: 0.95 }}
              onClick={() =>
                document
        ...
        <div className="grid grid-cols-3 gap-6">
          {features.map((f, i) => (
            ...
            >
              ...
              <button
                className="text-xs tracking-widest uppercase flex items-center gap-2 font-medium"
                style={{ color: '#C89B3C' }}
              >
